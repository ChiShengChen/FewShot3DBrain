...
\caption{Task 2 brain age regression (IXI): full six-sample stack. Orthogonal MRI views and regression results. Samples selected by lowest prediction error. All six have ground-truth age 50.0\,yr (IXI imputed default for missing metadata); see main text for caveat.}
